...
angular.module("myApp").controller('MenuController', ["LocalizationService", "$rootScope", function (LocalizationService, $rootScope) {
    var vm = this;
...
var socket = io.connect();
angular.module('chat').controller('ChatController', ["$window", "$rootScope", "$scope", "$compile", "LoginService", "$location", "ChatSocketService", "UserService", "LocalizationService", "LoadService", function ($window, $rootScope, $scope, $compile, LoginService, $location, ChatSocketService, UserService, LocalizationService, LoadService) {
    var vm = this;
    var self = this;
...
angular.module('login').controller('LoginController', ["$window", "$rootScope", "$location", "$http", "LoginService", "$scope", "LoginSocketService", "UserService", "LocalizationService", "LoadService", function ($window, $rootScope, $location, $http, LoginService, $scope, LoginSocketService, UserService, LocalizationService, LoadService) {
    var vm = this;
    vm.username = "";
    vm.pass = "";
    vm.submit = submit;
